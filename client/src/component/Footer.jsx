...
const Footer = ({theme}) => {
  ...
  <p className={`text-right text-xs ${theme === 'dark-mode'? 'text-white':'text-black'}`}>All rights reserved</p>
 <a
  ...
  className={`text-left text-xs mr-10 flex items-center gap-1 ${theme === 'dark-mode'? 'text-white':'text-black'}`}
>
