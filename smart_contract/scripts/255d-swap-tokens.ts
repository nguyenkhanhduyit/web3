...
async function main() {
    ...
    try {
        ...
        console.log("⚠️  Không thể lấy giá (có thể pool chưa có thanh khoản)");
    }
    ...
    if (balances.ETH >= swapAmount) {
        ...
        console.log("⚠️  Không đủ ETH để swap");
    }
    ...
    if (balances.USDT >= usdtSwapAmount) {
        ...
        console.log("⚠️  Không đủ USDT để swap");
    }
